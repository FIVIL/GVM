...
namespace GVM.Src.Types
{
    ...
    public struct Int256 : IComparable, IComparable<Int256>, IEquatable<Int256>
    {
        ...
        public Int256 PlusOne()
        {
            ...
            return new Int256() { data = d };
        }

        public Int256 MinusOne()
        {
            var d = new byte[32];
            var borrow = false;
            var pborrow = true;
        ...
        #region ComparingOperator
        public static bool operator >(Int256 a, Int256 b) => a.CompareTo(b) == 1 ? true : false;

        public static bool operator <(Int256 a, Int256 b) => a.CompareTo(b) == -1 ? true : false;

        public static bool operator >=(Int256 a, Int256 b) => a.CompareTo(b) >= 0 ? true : false;
        ...
        public static Int256 operator +(Int256 a) => new Int256() { data = a.data };
        public static Int256 operator -(Int256 a) => (~a).PlusOne();
        ...
        public static Int256 operator ++(Int256 a) => a.PlusOne();
        public static Int256 operator --(Int256 a) => a.MinusOne();
        #endregion
    }
}